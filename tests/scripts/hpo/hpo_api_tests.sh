...
. ${SCRIPTS_DIR}/hpo_scale_tests.sh
...
function hpo_api_tests() {
	...
	hpo_api_tests=("hpo_post_experiment"  "hpo_get_trial_json" "hpo_post_exp_result" "hpo_sanity_test" "hpo_grpc_sanity_test" "hpo_multiple_exp_test" "hpo_grpc_multiple_exp_test" "hpo_scale_tests")

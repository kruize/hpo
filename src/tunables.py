...
def get_all_tunables(search_space_json):
    ...
    experiment_trials = search_space_json["experiment_trials"]
    ...
    return experiment_name, experiment_trials, direction, hpo_algo_impl, id_, objective_function, tunables, value_type
